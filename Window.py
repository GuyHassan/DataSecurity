...
class data_screen:
    def __init__(self, top=None):
        ...
        self.import_to_txt_button.configure(text='''import to TXT''')
        self.import_to_txt_button.configure(width=106)
        tooltip_font = "TkDefaultFont"
        ToolTip(self.import_to_txt_button, tooltip_font, '''press to import the table to TXT file''', delay=0.5)

        self.Button2 = tk.Button(top)
        self.Button2.place(relx=0.862, rely=0.155, height=73, width=96)
        ...
        self.Button3.place(relx=0.862, rely=0.524, height=73, width=96)
        ...
        self.Button4.place(relx=0.862, rely=0.333, height=73, width=96)
    ...
    def import_url(self):
        ...
        self.Scrolledtext1.insert(tk.INSERT,Window_support.search_window(urlAddress))
        self.Scrolledtext1.configure(state="disabled")
